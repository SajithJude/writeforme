...
with st.sidebar:
    choose = option_menu("App Gallery", ["Write For Me", "Idea Generator", "Promotion Ideas", "Account", "person-dash"],
                         icons=['cpu', 'lightbulb fill', 'magnet fill', 'book','person lines fill'],
