...
with st.sidebar:
    choose = option_menu("App Gallery", ["Write For Me", "Idea Generator", "Promotion Ideas", "Account", "Log Out"],
                         ...
                         styles={
        "container": {"padding": "5!important", "background-color": "#fafafa", "box-shadow": "0px 0px 20px 5px #FF69B4"},
        "icon": {"color": "white", "font-size": "25px", "background-color":"grey","border-radius":"3px", "padding": "5!important"}, 
